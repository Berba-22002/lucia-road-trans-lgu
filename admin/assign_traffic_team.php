...
// Fetch forwarded TRAFFIC maintenance reports with detailed information
$query = "
    SELECT 
        rf.id as forward_id,
        r.id as report_id,
    ...
    WHERE rf.team_type = 'traffic_management' 
...
// Fetch all traffic reports for table with pagination
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['assign_maintenance'])) {
    ...
    try {
        ...
        $insert_assignment = "
            ...
            VALUES (?, ?, ?, ?, ?, ?, 'assigned', 'traffic_management', NOW())
        ";
        ...
        if ($report_data) {
            ...
            $notification_stmt->execute([
                $assigned_to,
                'New Traffic Management Assignment',
                'You have been assigned traffic management work for report #' . $report_id . ' (' . ucfirst($report_data['hazard_type']) . ') at ' . $report_data['address'],
                'info'
            ]);
        }
        
        $pdo->commit();
        $_SESSION['success'] = "Traffic management work assigned successfully!";
        header('Location: assign_traffic_team.php');
        exit();
...
<head>
    ...
    <title>Assign Traffic Management</title>
    ...
    <div class="lg:ml-64 flex flex-col h-screen">
            ...
            <header class="bg-white shadow-sm border-b border-lgu-stroke">
                <div class="flex items-center justify-between p-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h1 class="text-xl font-semibold text-lgu-headline">Assign Traffic Management</h1>
                    </div>
                </div>
            </header>
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <!-- Pending Traffic Management Reports -->
                                ...
                                <?php if (empty($reports)): ?>
                                    <div class="text-center py-8">
                                        <div class="bg-lgu-bg rounded-xl p-6 max-w-md mx-auto border border-lgu-stroke">
                                            ...
                                            <p class="text-lgu-paragraph">All traffic management reports have been assigned or there are no pending requests.</p>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="space-y-4">
            ...
            <form method="POST" action="" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea id="assignment_notes" name="assignment_notes" rows="4"
                              placeholder="Add specific instructions for traffic management work..."
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <button type="submit" name="assign_maintenance"
                        ...
                        <i class="fas fa-check"></i> Assign Traffic Work
                    </button>
                </div>
            </form>
        </div>
    ...
    <div id="imageModal" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50 hidden">
        <div class="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-hidden border border-lgu-stroke">
            <div class="flex justify-between items-center p-4 border-b border-lgu-stroke">
                <h3 class="text-lg font-semibold text-lgu-headline">Traffic Hazard Image</h3>
                ...
                if (data.results && data.results.length > 0) {
                    ...
                    let popupContent = `
                        <div class="p-2 text-xs">
                            <h4 class="font-bold text-red-600 mb-1">Traffic Hazard</h4>
