...
// Fetch bridge maintenance assignments
$query = "
    SELECT 
        ma.id,
        ma.report_id,
...
$stmt->execute();
$bridge_assignments = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<head>
    ...
    <title>Bridge Inspection Scheduler</title>
        ...
        <header class="bg-white shadow-sm border-b border-lgu-stroke">
            <div class="flex items-center justify-between p-4">
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-xl font-semibold text-lgu-headline">Bridge Inspection Scheduler</h1>
                </div>
            </div>
        </header>
                    ...
                    <?php if (empty($bridge_assignments)): ?>
                        <div class="text-center py-8">
                            <div class="bg-lgu-bg rounded-xl p-6 max-w-md mx-auto border border-lgu-stroke">
                                ...
                                <p class="text-lgu-paragraph">No bridge maintenance assignments have been created yet.</p>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="space-y-4">
                            <?php foreach ($bridge_assignments as $assignment): ?>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-4">
                                            <div class="bg-lgu-highlight bg-opacity-20 p-3 rounded-lg">
                                                <i class="fas fa-bridge text-lgu-headline"></i>
                                            </div>
                                            <div>
