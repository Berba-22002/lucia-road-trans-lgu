...
try {
    ...
    $stmt = $pdo->query("
        ...
        JOIN ovr_tickets ot ON mp.ticket_id = ot.id
        JOIN users u ON mp.resident_id = u.id
                            ...
                            <?php else: ?>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-lgu-bg transition">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo $payment['status'] === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'; ?>">
