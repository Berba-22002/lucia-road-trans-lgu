...
<body class="bg-lgu-bg min-h-screen">
                    ...
                    <!-- Manual Hazard Level for Video -->
                        ...
                        <div class="form-section border-t border-gray-200 pt-8">
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <a href="resident-dashboard.php" class="btn-secondary bg-gray-300 text-gray-700 font-bold py-4 px-8 rounded-xl hover:bg-gray-400 transition flex items-center justify-center gap-3 text-lg min-w-[200px]">
    ...
    <script>
        ...
        // Extract and analyze key frame from video
        async function analyzeVideoFrame(videoElement) {
            ...
            try {
                ...
                img.onload = async function() {
                    ...
                    let hazardLevel = 'low';
                    if (predictions[0].probability > 0.8) hazardLevel = 'high';
                    else if (predictions[0].probability > 0.6) hazardLevel = 'medium';
